...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    ...
    <script>
        ...
        <?php if($config == 'config'){?>
             ...
             document.title = "eSchool | Class Details"
        <?php } ?>
        ...
        $(document).ready(function(){
            ...
            $("#addClass").validate({
            	...
            	messages: {
                    ...
                    class_minimum_attendance:{
                        pattern:"Please enter less than 100%."
                    },
                    class_attendance_type:{
                        min:"Please Select Class Attendance type.."
                    }
            	}
            });
            ...
            $("#addDivision").validate({
                ...
                messages: {
                    division_name:{
                        required:"Please Enter the School Division Name.",
                        pattern:"Please Enter only charater or digits."
                    },
                    division_class_id:{
                        min: "Please Select Class."
