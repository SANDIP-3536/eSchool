                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    <center>
                        <div class="navbar-header" style="border-bottom: 1px solid gray;box-shadow: 2px 1px #888888;float: inherit;">
                         <img class="img-responsive" src="<?=base_url()?>profile_photo/LBD.png" style="width: 6%;float: left;margin-left: 194px;padding: 5px;">
                ...
                <div class="ibox float-e-margins">
                     <div class="enquiry_details">
                        <div class="ibox-title">
                            ...
                            <?php if($LBD_pre_primary_school_enquiry_id == 0 && $LBD_primary_school_enquiry_id == 0){ ?>
                                <center><img src="<?=base_url()?>assets/img/School_Admission.png" class="img-responsive"></center>
                            <?php }else{ ?>
                            <form method="post" class="form-horizontal" action="<?=site_url('Enquiry/add_LBD_enquiry')?>" enctype="multipart/form-data" id="add_enquiry">
                                   ...
                                   <!--  <div class="form-group" hidden>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                   <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio1" class="lbd_pre_class" value="4" name="enquiry_school_profile_id" checked>
                                                        <label for="inlineRadio1"> LBD International School (PrePrimary) </label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio2" value="5" name="enquiry_school_profile_id">
                                                        <label for="inlineRadio2"> LBD International Pre Pri School </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" name="student_first_name" placeholder="First Name" id="student_first_name" onkeyup="capitalize(this.id, this.value);">
                                                </div>
                                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-control LBD_admission_class" name="enquiry_admission_class">
                                                <option value="">Select Class</option>
                                            <?php if ($LBD_pre_primary_school_enquiry_id != 0) {?>
                                                <option value="Nursery">Nursery</option>
                                                <option value="Junior_kg">Junior kg</option>
                                                <option value="Senior_kg">Senior kg</option>
                                            <?php } ?>
                                            <?php if ($LBD_primary_school_enquiry_id != 0) {?>
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-control LBD_enquiry_year" name="enquiry_acadmic_year"></select>
                                        </div>
                                    </div>
                                </div>
                                <div class="ibox-content"  style="background-color: #f6f6f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control " name="father_first_name" placeholder="First Name" id="father_first_name" onkeyup="capitalize(this.id, this.value);">
                                                </div>
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" name="father_middle_name" placeholder="Middle Name" id="father_middle_name" onkeyup="capitalize(this.id, this.value);">
                                                </div>
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" name="father_last_name" placeholder="Last Name" id="father_last_name" onkeyup="capitalize(this.id, this.value);">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="father_occupation" placeholder=" Occupation." id="Occupation" onkeyup="capitalize(this.id, this.value);"> 
                                        </div>
                                        <label class="col-sm-2 control-label">Place of work. </label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control " id="place_of_work" name="father_work_place" placeholder=" Place of work" onkeyup="capitalize(this.id, this.value);">
                                        </div>
                                    </div>
                                </div>
                                <div class="ibox-content"  style="background-color: #f6f6f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" name="mother_first_name" placeholder="First Name" id="mother_first_name" onkeyup="capitalize(this.id, this.value);">
                                                </div>
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" name="mother_middle_name" placeholder="Middle Name" id="mother_middle_name" onkeyup="capitalize(this.id, this.value);">
                                                </div>
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" name="mother_last_name" placeholder="Last Name" id="mother_last_name" onkeyup="capitalize(this.id, this.value);">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Occupation. </label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" id="mother_occupationion" name="mother_occupation" placeholder=" Occupation." onkeyup="capitalize(this.id, this.value);">
                                        </div>
                                        <label class="col-sm-2 control-label">Place of work. </label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" id="mother_place" name="mother_work_place" placeholder=" Place of work" onkeyup="capitalize(this.id, this.value);">
                                        </div>
                                    </div>
                                </div>
                                <div class="ibox-content"  style="background-color: #f6f6f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control " name="student_privious_school_name" placeholder="Previous School Name" id="school_name" onkeyup="capitalize(this.id, this.value);">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="student_last_attend_class" placeholder=" Last Attend Class." id="attend_class" onkeyup="capitalize(this.id, this.value);">
                                        </div>
                                        <label class="col-sm-2 control-label">Reason</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="student_privious_school_left_reason" placeholder=" School Left Reason" id="left_reason" onkeyup="capitalize(this.id, this.value);">
                                        </div>
                                    </div>
                                </div>
                                <div class="ibox-content"  style="background-color: #f6f6f7;">
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                         <input type="text" class="form-control" name="enquiry_house_no" placeholder="Enter the House No./Street Name/Landmark." id="enquiry_house_no" onkeyup="capitalize(this.id, this.value);">
                                    </div>
                                    <label class="col-lg-2 control-label">Town</label>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control" name="enquiry_town" placeholder="Enter the Home Town." id="enquiry_town" onkeyup="capitalize(this.id, this.value);">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Taluka</label>
                                    <div class="col-lg-3">
                                         <input type="text" class="form-control" name="enquiry_tal" placeholder="Enter the taluka." id="enquiry_tal" onkeyup="capitalize(this.id, this.value);">
                                    </div>
                                    <label class="col-lg-2 control-label">District</label>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control" name="enquiry_dist" placeholder="Enter the District." id="enquiry_dist" onkeyup="capitalize(this.id, this.value);">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea type="text" placeholder="Comment" name="expectation" class="form-control" id="expection" onkeyup="capitalize(this.id, this.value);"></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog" style="width:550px !important;">
                        <div class="modal-content animated fadeIn">
                            ...
                            <div class="modal-body">
                                <form method="post" class="form-horizontal" enctype="multipart/form-data" id="enquiry_status_" action="<?=site_url('Enquiry/LBD_enquiry_status_details')?>">
                                    <div class="form-group"> 
                                    ...
                                    <div class="form-group other_search">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="first_name" id="first_name" required onkeyup="capitalize(this.id, this.value);">
                                        </div>
                                    </div>
                                    <div class="form-group other_search">
...
$(document).ready(function(){
    ...
    <?php if(isset($flash['active']) && $flash['active'] == 1) {?>
        ...
        $(".lbd_IN_class_details").hide();
        $("input[name$='enquiry_school_profile_id']").click(function(){
            var value = $(this).val();
            if(value=='4') {
                $(".lbd_pre_class_details").show();
                $(".lbd_IN_class_details").hide();
            }
            else if(value=='5') {
                $(".lbd_IN_class_details").show();
                $(".lbd_pre_class_details").hide();
            }
        });
