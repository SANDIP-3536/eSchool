...
<body class="top-navigation">
    <div id="wrapper">
                            ...
                            <div class="enquiry_status">
                                <div class="ibox-title">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a href="<?=base_url()?>index.php/Enquiry/enquiry_form_LBD"><button class ="btn btn-xs btn-success" style="float:right;"> Enquiry form</button></a>
                                ...
                                <?php } ?>
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        <thead>
                                            ...
                                            <tr>
                                                <th colspan = "6"  style="background-color: #d0d2ce;color:#000000;"><b>Address Details</b></th>
                                            </tr>
                                            <tr>
                                                <td><b>House No./ Landmark</b></td>
                                                <td style="background-color: #ffffff;"><b><?php echo $status[0]['enquiry_house_no']; ?></b></td>
                                                <td><b>Town</b></td>
                                                <td style="background-color: #ffffff;"><b><?php echo $status[0]['enquiry_town']; ?></b></td>
                                                <td><b>Taluka</b></td>
                                                <td style="background-color: #ffffff;"><b><?php echo $status[0]['enquiry_tal']; ?></b></td>
                                            </tr>
                                            <tr>
                                                <td><b>District</b></td>
                                                <td style="background-color: #ffffff;"><b><?php echo $status[0]['enquiry_dist']; ?></b></td>
                                                <td><b>State</b></td>
                                                <td style="background-color: #ffffff;"><b><?php echo $status[0]['enquiry_state']; ?></b></td>
                                                <td><b>Pincode</b></td>
                                                <td style="background-color: #ffffff;"><b><?php echo $status[0]['enquiry_pincode']; ?></b></td>
                                            </tr>
                                            <tr>
        ...
        <div id="example" class="gray-bg hidden" style="background-color: gray;">
            <div class="row border-bottom white-bg">
                <nav class="navbar navbar-static-top" role="navigation">
                    <center>
                        <div class="navbar-header" style="border-bottom: 1px solid gray;box-shadow: 2px 1px #888888;float: inherit;">
