...
<?php 
$path = base_url('assets')."/img/login_background.gif";
...
<body class="gray-bg" style="background: url('<?php echo $path;?>') no-repeat center center fixed;background-size: cover;" >
    ...
    <div style="border:none; backgorund:none repeat scroll 0 0 #cde7a6 !important;padding:10px 20px;right:0;left:0;bottom:0;position: fixed;opacity: 0.7;z-index: -1;background-color: #ffffff;">
        <div class="row">
            <div class="col-sm-3">
                <div class="pull-left">
                    <center><strong>Copyright </strong><a href="http://www.syntech.co.in" target="_blank"> <img src="<?=base_url()?>assets/img/syntech1.png" style="height:22px;"></a><strong>&copy; 2017-2018</strong>  </center>
                </div>
            </div>
            <div class="pull-right" style="color: #000000;">
                <center><i class="fa fa-phone-square" aria-hidden="true"></i><strong> 020-24269021 / 7030578612</strong> | <i class="fa fa-envelope" aria-hidden="true"></i> <strong>contactus@syntech.co.in </strong></center> 
            </div>
        </div>
    </div>
